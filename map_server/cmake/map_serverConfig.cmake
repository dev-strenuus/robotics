...
if("FALSE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-map-server-1.14.3)
  set(map_server_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-map-server-1.14.3/obj-x86_64-linux-gnu/devel)
  ...
  set(map_server_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
